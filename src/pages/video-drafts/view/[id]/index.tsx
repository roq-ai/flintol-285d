...
import { getVideoDraftById } from 'apiSdk/video-drafts';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Video Draft Detail View
          </Text>
          {hasAccess('video_draft', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/video-drafts/edit/${data?.id}`} passHref legacyBehavior>
              <Button
